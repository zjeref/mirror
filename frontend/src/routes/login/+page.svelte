...
<div class="h-full flex items-center justify-center px-4 bg-gradient-to-b from-[var(--color-surface)] to-[#0c0c1f]">
	...
	<div class="w-full max-w-sm relative z-10">
		<div class="text-center mb-10">
			...
			<p class="text-[var(--color-on-surface-variant)]/60 text-sm">See yourself clearly. Grow gently.</p>
		</div>
		...
		<form onsubmit={handleSubmit} class="space-y-4">
			...
			<p class="text-center text-sm text-[var(--color-outline)]">
				...
				<a href="/register" class="text-[var(--color-primary)] hover:text-[var(--color-tertiary)] transition-colors">Sign up</a>
			</p>
		</form>
	</div>
</div>
